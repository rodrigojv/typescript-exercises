...
function getObjectKeys(criteria: Partial<User>): (keyof Person)[];
function getObjectKeys(criteria: Partial<Admin>): (keyof Person)[];
function getObjectKeys(criteria: any): any[] {
...
let usersOfAge23: User[] = filterPersons(persons, "user", {
  age: 23,
});
let adminsOfAge23: Admin[] = filterPersons(persons, "admin", {
  age: 23,
});
